...
# Fix CUDA_ERROR_ILLEGAL_ADDRESS in kernel 'loop_dynamic_update_slice_fusion':
# This kernel is generated by XLA fusing dynamic_update_slice ops inside
# jax.lax.scan (used by RSSM). The fused kernel has a memory access bug.
# --xla_gpu_enable_dynamic_slice_fusion=false is the precise fix.
